...
After running =vend get=, you can inspect your full dependency graph via =vend
graph=:
...
If the graph is too messy, you can "focus" it with an extra argument to =vend
graph=:
...
Since your dependencies are you code, you should care about what's in there.
